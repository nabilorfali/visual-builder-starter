...
const BiolageSocialProof = (props) => {
  return (
    <Container
      tag="section"
      className={` ${styles['biolage-social-proof']} ${
...
BiolageSocialProof.defaultProps = {
  rendering: {},
  rootClassName: '',
  data: {
...
BiolageSocialProof.propTypes = {
  rendering: PropTypes.object,
  rootClassName: PropTypes.string,
  data: PropTypes.object,
}

export default BiolageSocialProof
