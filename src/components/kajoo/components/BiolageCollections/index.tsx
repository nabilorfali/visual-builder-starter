...
const BiolageCollections = (props) => {
  return (
    <Container
      tag="section"
      className={` ${styles['biolage-collections']} ${
...
BiolageCollections.defaultProps = {
  rendering: {},
  rootClassName: '',
  data: {
    Title: 'Lorem Ipsum',
...
BiolageCollections.propTypes = {
  rendering: PropTypes.object,
  rootClassName: PropTypes.string,
  data: PropTypes.object,
}

export default BiolageCollections
