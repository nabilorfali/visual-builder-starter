...
const AmicaBackgroundDifferentiatorPanel = (props) => {
  return (
    <Container
      tag="section"
      role="complementary"
      aria-label="Background Panel"
      className={` ${styles['amica-background-differentiator-panel']} ${
...
AmicaBackgroundDifferentiatorPanel.defaultProps = {
  rendering: {},
  rootClassName: '',
  data: {
    FullImageLink: '',
...
AmicaBackgroundDifferentiatorPanel.propTypes = {
  rendering: PropTypes.object,
  rootClassName: PropTypes.string,
  data: PropTypes.object,
}

export default AmicaBackgroundDifferentiatorPanel
