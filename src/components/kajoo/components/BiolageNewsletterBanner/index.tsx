...
const BiolageNewsletterBanner = (props) => {
  return (
    <Container
      tag="section"
      className={` ${styles['biolage-newsletter-banner']} ${
...
BiolageNewsletterBanner.defaultProps = {
  rendering: {},
  rootClassName: '',
  data: {
...
BiolageNewsletterBanner.propTypes = {
  rendering: PropTypes.object,
  rootClassName: PropTypes.string,
  data: PropTypes.object,
}

export default BiolageNewsletterBanner
