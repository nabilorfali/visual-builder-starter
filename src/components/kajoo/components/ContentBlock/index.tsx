...
const ContentBlock = (props) => {
  return (
    ...
    >
      ...
      <Container className={styles['column-container']}>
        <RichText value={props.data.Content} className={styles['rich-text']} />
      </Container>
    </Container>
  )
}
