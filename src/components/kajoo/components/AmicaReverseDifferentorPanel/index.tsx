...
const AmicaReverseDifferentorPanel = (props) => {
  return (
    <Container
      tag="section"
      role="complementary"
      aria-label="Reverse Panel"
      className={` ${styles['amica-reverse-differentor-panel']} ${
...
AmicaReverseDifferentorPanel.defaultProps = {
  rendering: {},
  rootClassName: '',
  data: {
    FullImageLink: '',
...
AmicaReverseDifferentorPanel.propTypes = {
  rendering: PropTypes.object,
  rootClassName: PropTypes.string,
  data: PropTypes.object,
}

export default AmicaReverseDifferentorPanel
