...
const TestReverseDifferentorPanel = (props) => {
  return (
    <Container
      tag="section"
      role="complementary"
      aria-label="Reverse Panel"
      className={` ${styles['test-reverse-differentor-panel']} ${
...
TestReverseDifferentorPanel.defaultProps = {
  rendering: {},
  rootClassName: '',
  data: {
    FullImageLink: '',
...
TestReverseDifferentorPanel.propTypes = {
  rendering: PropTypes.object,
  rootClassName: PropTypes.string,
  data: PropTypes.object,
}

export default TestReverseDifferentorPanel
