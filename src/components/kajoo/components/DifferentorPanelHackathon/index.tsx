...
const DifferentorPanelHackathon = (props) => {
  return (
    <Container
      tag="section"
      role="complementary"
      aria-label="Panel"
      className={` ${styles['differentor-panel-hackathon']} ${
...
DifferentorPanelHackathon.defaultProps = {
  rendering: {},
  rootClassName: '',
  data: {
    FullImageLink: '',
...
DifferentorPanelHackathon.propTypes = {
  rendering: PropTypes.object,
  rootClassName: PropTypes.string,
  data: PropTypes.object,
}

export default DifferentorPanelHackathon
