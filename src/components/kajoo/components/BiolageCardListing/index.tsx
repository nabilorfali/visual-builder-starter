...
const BiolageCardListing = (props) => {
  return (
    <Container
      tag="section"
      id="promise"
      className={` ${styles['biolage-card-listing']} ${
...
BiolageCardListing.defaultProps = {
  rendering: {},
  rootClassName: '',
  data: {
...
BiolageCardListing.propTypes = {
  rendering: PropTypes.object,
  rootClassName: PropTypes.string,
  data: PropTypes.object,
}

export default BiolageCardListing
