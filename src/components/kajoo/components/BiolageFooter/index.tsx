...
const BiolageFooter = (props) => {
  return (
    <Container
      tag="footer"
      className={` ${styles['biolage-footer']} ${styles[props.rootClassName]} `}
    >
...
BiolageFooter.propTypes = {
  rendering: PropTypes.object,
  rootClassName: PropTypes.string,
  data: PropTypes.object,
}

export default BiolageFooter
